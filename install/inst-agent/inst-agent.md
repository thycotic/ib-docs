...
Examining pmagent_x86_64_v1.1.1.rpm:  pmagent_x86_64_1.1.16
Marking pmagent_x86_64_v1.1.1.rpm to be installed
Resolving Dependencies
--> Running transaction check
---> Package pmagent.x86_64 0:1.1.16 will be installed
...
pmagent         x86_64        1.1.16        /pmagent_x86_64_v1.1.1       50 M
...
Running transaction
  Installing : pmagent_x86_64_1.1.16 1/1
Created symlink from /etc/systemd/system/multi-user.target.wants/pmagent.service to /etc/systemd/system/pmagent.service.
...
Verifying : pmagent_x86_64_1.1.16 1/1

Installed:
pmagent_x86_64_1.1.16
Complete!
```
