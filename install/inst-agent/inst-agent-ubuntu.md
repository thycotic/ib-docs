...
`>> sudo dpkg -i pmagent-1.1.3.79-Linux.deb`
...
Preparing to unpack pmagent-1.1.3.79-Linux.deb ...
...
`>> sudo apt install /root/Thycotic/pmagent-1.1.3.79-Linux.deb`
...
Note, selecting 'pmagent' instead of '/home/installer/pmagent-1.1.3.79-Linux.deb'
...
Get:1 /home/installer/pmagent-1.1.3.79-Linux.deb pmagent amd64 1.1.3.79 [8,669 kB]
Selecting previously unselected package pmagent.
(Reading database ... 184828 files and directories currently installed.)
Preparing to unpack .../pmagent-1.1.3.79-Linux.deb ...
Unpacking pmagent (1.1.3.79) ...
